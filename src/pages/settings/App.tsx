...
const Settings: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (!uidCookie) return;
        const getInputUid = document.getElementById(
            "player-set-uid"
        ) as HTMLInputElement;
    ...
    const handleCheck = async () => {
        const uid = (
            document.getElementById("player-set-uid") as HTMLInputElement
        )?.value;
        const code = (
            document.getElementById("player-set-code") as HTMLInputElement
        )?.value;
        if (!uid || !code) {
    ...
    const handleSelectAccount = useCallback(
        (value: string) => {
            ...
            setOutputText(
                t("output.successfully_selected_account", { name: name }),
                "green"
            );
        },
