...
const ForwardedTooltipTrigger = React.forwardRef<
    HTMLDivElement,
...
const ListServerAvailable: React.FC<ListServerAvailableProps> = memo(
    ({ handleSelectAccount, listServerAvailable }) => {
                ...
                <div className="mt-2 flex flex-col items-center gap-y-4 text-left text-sm">
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent>
                            ...
                            <DropdownMenuRadioGroup
                                onValueChange={handleClickServerList}
                                className="w-96"
                            >
                                <ScrollArea
                                ...
                                >
                                    {filteredListServerAvailable.map(
                                        (server, index) => (
                                            <React.Fragment
                                                key={`available-server-fragment-${server.id}`}
                                            >
                                                {index !== 0 && (
                                                    <Separator
                                                        key={`available-server-separator-${server.id}`}
                                                    />
                                                )}
                                                <DropdownMenuRadioItem
