			...
			<div className='footer'>
				<nav>
					...
					<FooterLink
						...
						label='Discord'
					/>
					<FooterLink href='https://github.com/ElaXan' icon={<FaGithub />} label='GitHub' />
					<FooterLink href='https://gitlab.com/ElaXan' icon={<FaGitlab />} label='GitLab' />
				</nav>
				<nav>
					<header className='footer-title'>Handbook Finder</header>
					<FooterLink href='https://gitlab.com/YuukiPS/handbook' icon={<FaGitlab />} label='GitLab' />
				</nav>
				<nav>
					...
					<FooterLink
						...
						label='BuyMeaCoffee'
					/>
					<FooterLink href='https://saweria.co/ElaXan' icon={<div />} label='Saweria' />
				</nav>
			</div>
