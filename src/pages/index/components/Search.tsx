...
const Search: React.FC<SearchProps> = ({ loadGI, loadSR, currentLanguage, state, setState }) => {
	...
	const [sliderValue, setSliderValue] = useState<number[]>([cookie.limitsResult || 30])
	...
	}, [state.searchTerm, state.currentType, handleSearch, loadGI, loadSR, setState])
	...
	return (
		<div className='mt-5 flex justify-center'>
			...
			>
				...
				>
					<Label className='flex justify-center'>{t('label.api_settings')}</Label>
								...
								<div className='flex items-center mr-1'>
									<TooltipProvider>
										<Tooltip>
											...
											<TooltipContent>
												Force update the handbook path even if it's the same
											</TooltipContent>
										</Tooltip>
									</TooltipProvider>
								</div>
					...
					<div className='m-2 space-y-1'>
						<Select value={state.currentType} onValueChange={(e) => handleTypeChange(e)}>
							<SelectTrigger>
