			...
			{!isTauri() && (
				<Dialog open={true}>
					<DialogContent className='sm:max-w-[425px]'>
						<DialogHeader>
							<DialogTitle className='text-xl font-semibold'>Unsupported Platform</DialogTitle>
							<DialogDescription className='text-sm text-gray-500'>
								This feature is currently only supported on Windows and Android. The web browser version
